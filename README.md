...
- ✅ Increment 3b-3h: sync+calibration + border + nearest-palette + RS shards + per-shard hash + MKV decode + corner fiducials
- ⏭️ Next: detect fiducials in camera frames, compute homography, and deskew to grid
